...
const Card1 = ({ gameId }: any) => {
  return (
    <div className={instructionStyles.view}>
      <Image src={image3} alt="start instruction" />
      <h1>
...
const Card2 = ({ gameId }: any) => {
  return (
    <div className={instructionStyles.view}>
      <Image src={image4} alt="next card instruction" />
      <h1>
...
const Card4 = ({ gameId }:any) => {
  return (
    <div className={instructionStyles.view}>
      <Image src={image6} alt="back button instruction" />
      <h1>
...
const Card5 = ({ gameId }: any) => {
  return (
    <div className={instructionStyles.view}>
      <Image style={{ marginTop: "-35px" }} src={image7} alt="exit instruction" />
      <h1>
